...
import {
  ...
  Events,
  EntertainmentImage,
} from "../config/TempPosters.config";
...
export const HomePage = () => {
  ...
  return (
    <>
      <div className="flex flex-col gap-4 md:gap-8 lg:gap-14">
        <div className="w-[98%] md:w-11/12 lg:w-5/6 mx-auto">
          <PosterSlider
        ...
        <img
          className="hidden md:block rounded-lg w-5/6 mx-auto my-5"
        ...
        />
        <img
          className="md:hidden rounded w-[95%] mx-auto my-2"
          src="https://assets-in.bmscdn.com/promotions/cms/creatives/1682618069363_appbannernpa.jpg"
          alt="Advertisement"
        />
        <div className="container mx-auto w-[98%] md:w-11/12 lg:w-5/6 ">
        ...
        <div className="bg-navCol-100 pb-5">
          <div className="container mx-auto w-[98%] md:w-11/12 lg:w-5/6 flex flex-col gap-1 md:gap-2 lg:gap-3 ">
            <div className="flex">
              <img
                src="https://assets-in.bmscdn.com/discovery-catalog/collections/tr:w-1440,h-480:w-600:q-80/stream_hp_banner-collection-202210130606.jpg"
                alt="Premier"
        ...
        <div className="w-[98%] md:w-11/12 lg:w-5/6 mx-auto mb-2 md:mb-4">
          <PosterSliderCommon
            images={Events}
